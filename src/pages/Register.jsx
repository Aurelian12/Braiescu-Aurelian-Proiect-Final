...
export function Register() {
  ...
  return (
    ...
    >
      <Typography sx={{ fontFamily: "Montserrat", fontWeight: 700, color: red["A200"] }} variant="h2">
        Register
      </Typography>
      <Box
      ...
      >
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <TextField
              InputLabelProps={{
                style: { color: red["A200"], fontFamily: "Montserrat", fontSize: 16, fontWeight: 700 },
              }}
        ...
        <Link
          style={{ fontFamily: "Inter", fontWeight: 700, fontSize: 18, color: red["A200"] }}
          component={NavLink}
          to="/"
          variant="contained"
        >
